...
| [Visual / Visual-Inertial State Estimation](docs/categories/visual-inertial-odometry.md) | 68 | Visual state estimation, visual-inertial state estimation, monocular/stereo/RGB-D VO, and VIO SLAM systems. |
...
| [Mapping & Map Representation](docs/categories/mapping-map-representation.md) | 179 | Mapping, map representation, occupancy/voxel/surfel/TSDF maps, neural maps, NeRF, and 3D Gaussian Splatting. |
...
| [Multi-Robot SLAM & Collaborative Perception](docs/categories/multi-robot-slam.md) | 61 | Multi-robot SLAM, distributed mapping, collaborative perception, V2X perception, and multi-agent fusion. |
...
| [Degeneracy, Robustness & Failure Analysis](docs/categories/degeneracy-robustness.md) | 17 | Degeneracy analysis, robustness, failure detection, outlier rejection, and uncertainty-aware SLAM. |
...
| [GNSS, HD Map & Global Localization](docs/categories/gnss-hd-map-localization.md) | 32 | GNSS/INS, RTK, HD maps, map matching, global localization, and map-based relocalization. |
...
| [Tools, Engineering & Productivity](docs/categories/tools-engineering-productivity.md) | 202 | ROS/ROS2 tools, Docker/reproduction environments, visualization, annotation, productivity, LLM tools, C++ resources, and research utilities. |
