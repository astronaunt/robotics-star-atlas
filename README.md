...
<p align="center">
  <img alt="Indexed repositories" src="https://img.shields.io/badge/indexed%20repos-1398-1f6f5b">
  <img alt="Categories" src="https://img.shields.io/badge/categories-27-2f4858">
  <img alt="Fetched repositories" src="https://img.shields.io/badge/fetched-1395-4f7f52">
</p>
...
<table>
  <tr>
    ...
    <td><strong>Indexed repositories</strong><br><code>1398</code></td>
    <td><strong>Categories</strong><br><code>27</code></td>
  </tr>
  <tr>
    <td><strong>Fetched successfully</strong><br><code>1395</code></td>
...
| --- | ---: | --- |
| [LiDAR-Inertial State Estimation](docs/categories/lidar-inertial-odometry.md) | 153 | LiDAR-IMU state estimation, LIO SLAM, filtering/smoothing-based LIO, and LIO mapping systems. |
...
| [Visual / Visual-Inertial State Estimation](docs/categories/visual-inertial-odometry.md) | 71 | Visual state estimation, visual-inertial state estimation, monocular/stereo/RGB-D VO, and VIO SLAM systems. |
...
| [Place Recognition & Loop Closure](docs/categories/place-recognition-loop-closure.md) | 106 | Place recognition, loop closure, scan context, global descriptors, retrieval, and relocalization triggers. |
| [Mapping & Map Representation](docs/categories/mapping-map-representation.md) | 184 | Mapping, map representation, occupancy/voxel/surfel/TSDF maps, neural maps, NeRF, and 3D Gaussian Splatting. |
...
| [Radar SLAM & Perception](docs/categories/radar-slam-perception.md) | 39 | Radar state estimation, radar SLAM, mmWave radar perception, imaging radar, and radar-LiDAR fusion. |
...
| [Degeneracy, Robustness & Failure Analysis](docs/categories/degeneracy-robustness.md) | 19 | Degeneracy analysis, robustness, failure detection, outlier rejection, and uncertainty-aware SLAM. |
...
| [Datasets & Benchmarks](docs/categories/datasets-benchmarks.md) | 61 | Datasets, benchmarks, leaderboards, dataset APIs, ground truth, and evaluation protocols. |
