...
<p align="center">
  <img alt="Indexed repositories" src="https://img.shields.io/badge/indexed%20repos-1402-1f6f5b">
  <img alt="Categories" src="https://img.shields.io/badge/categories-27-2f4858">
  <img alt="Fetched repositories" src="https://img.shields.io/badge/fetched-1399-4f7f52">
</p>
...
<table>
  <tr>
    ...
    <td><strong>Indexed repositories</strong><br><code>1402</code></td>
    <td><strong>Categories</strong><br><code>27</code></td>
  </tr>
  <tr>
    <td><strong>Fetched successfully</strong><br><code>1399</code></td>
...
| [Mapping & Map Representation](docs/categories/mapping-map-representation.md) | 185 | Mapping, map representation, occupancy/voxel/surfel/TSDF maps, neural maps, NeRF, and 3D Gaussian Splatting. |
...
| [Multi-Robot SLAM & Collaborative Perception](docs/categories/multi-robot-slam.md) | 65 | Multi-robot SLAM, distributed mapping, collaborative perception, V2X perception, and multi-agent fusion. |
...
| [Planning & Navigation](docs/categories/planning-navigation.md) | 72 | Motion planning, path planning, trajectory optimization, navigation stacks, and control. |
