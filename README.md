...
<p align="center">
  <img alt="Indexed repositories" src="https://img.shields.io/badge/indexed%20repos-1388-1f6f5b">
  <img alt="Categories" src="https://img.shields.io/badge/categories-27-2f4858">
  <img alt="Fetched repositories" src="https://img.shields.io/badge/fetched-1385-4f7f52">
</p>
...
<table>
  <tr>
    ...
    <td><strong>Indexed repositories</strong><br><code>1388</code></td>
    <td><strong>Categories</strong><br><code>27</code></td>
  </tr>
  <tr>
    <td><strong>Fetched successfully</strong><br><code>1385</code></td>
...
| --- | ---: | --- |
| [LiDAR-Inertial State Estimation](docs/categories/lidar-inertial-odometry.md) | 150 | LiDAR-IMU state estimation, LIO SLAM, filtering/smoothing-based LIO, and LIO mapping systems. |
...
| [Mapping & Map Representation](docs/categories/mapping-map-representation.md) | 183 | Mapping, map representation, occupancy/voxel/surfel/TSDF maps, neural maps, NeRF, and 3D Gaussian Splatting. |
...
| [Multi-Robot SLAM & Collaborative Perception](docs/categories/multi-robot-slam.md) | 63 | Multi-robot SLAM, distributed mapping, collaborative perception, V2X perception, and multi-agent fusion. |
...
| [Degeneracy, Robustness & Failure Analysis](docs/categories/degeneracy-robustness.md) | 20 | Degeneracy analysis, robustness, failure detection, outlier rejection, and uncertainty-aware SLAM. |
...
| [Planning & Navigation](docs/categories/planning-navigation.md) | 71 | Motion planning, path planning, trajectory optimization, navigation stacks, and control. |
