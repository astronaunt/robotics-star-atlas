...
| --- | ---: | --- |
| [LiDAR-Inertial State Estimation](categories/lidar-inertial-odometry.md) | 153 | LiDAR-IMU state estimation, LIO SLAM, filtering/smoothing-based LIO, and LIO mapping systems. |
...
| [Datasets & Benchmarks](categories/datasets-benchmarks.md) | 61 | Datasets, benchmarks, leaderboards, dataset APIs, ground truth, and evaluation protocols. |
