...
- [rsasaki0109/lidar_slam_ros2](https://github.com/rsasaki0109/lidar_slam_ros2) - ROS 2 LiDAR SLAM for pointcloud-map authoring, benchmarking, and Autoware-compatible map workflows.
...
- [NeBula-Autonomy/LOCUS](https://github.com/NeBula-Autonomy/LOCUS) - Robust Lidar Odometry System
...
- [utiasASRL/steam_icp](https://github.com/utiasASRL/steam_icp) - Continuous-time lidar, radar, lidar-inertial, and radar-inertial odometry
...
- [ryanbgriffiths/ICRA2023PaperList](https://github.com/ryanbgriffiths/ICRA2023PaperList) - ICRA2023 Paper List
...
- [vb44/SiMpLE](https://github.com/vb44/SiMpLE) - A simple LiDAR odometry method reducing the complexity and configuration burden of localization algorithms.
- [huashu996/Onion-LO](https://github.com/huashu996/Onion-LO)
- [chengwei0427/CTLO](https://github.com/chengwei0427/CTLO) - CTLO: Continuous-Time LiDAR Odometry
...
- [ali-pahlevani/GenZ_ICP_Optimized](https://github.com/ali-pahlevani/GenZ_ICP_Optimized) - GenZ-ICP: SOTA robust LiDAR odometry (IEEE RA-L 2025) (Optimized version for reduced CPU usage)
- [KennyWGH/ground_aware_cartographer](https://github.com/KennyWGH/ground_aware_cartographer)
- [anastasiia-kornilova/python-LOAM](https://github.com/anastasiia-kornilova/python-LOAM) - Python implementation of LOAM algorithm by Ji Zhang and Sanjiv Singh
- [fracgawd/kitti_motion_compensation](https://github.com/fracgawd/kitti_motion_compensation)
- [gisbi-kim/SC-LeGO-LOAM](https://github.com/gisbi-kim/SC-LeGO-LOAM) - backup of irapkaist/SC-LeGO-LOAM
- [IRMVLab/PWCLONet](https://github.com/IRMVLab/PWCLONet) - Codes for CVPR2021 paper "PWCLO-Net: Deep LiDAR Odometry in 3D Point Clouds Using Hierarchical Embedding Mask Optimization"
- [LiShuaixin/aloam_gtsam](https://github.com/LiShuaixin/aloam_gtsam) - Advanced-LOAM modified by gtsam
- [yjsx/PFilter](https://github.com/yjsx/PFilter) - Building Persistent Maps through Feature Filtering for Fast and Accurate LiDAR-based SLAM
- [LarryDong/p2v-slam](https://github.com/LarryDong/p2v-slam) - Point-to-voxel LiDAR SLAM
- [UCR-Robotics/AG-LOAM](https://github.com/UCR-Robotics/AG-LOAM) - COMPAG 2025: Adaptive LiDAR-only Odometry and Mapping Framework in Agricultural Environments
- [rvp-group/mad-ba](https://github.com/rvp-group/mad-ba)
- [kevin2431/ECTLO](https://github.com/kevin2431/ECTLO) - ECTLO: Effective Continuous-Time Odometry Using Range Image for LiDAR with Small FoV.(IROS2023)
- [G3tupup/ctlo](https://github.com/G3tupup/ctlo) - continuous time lidar odometry
- [YZH-bot/SC-DLO](https://github.com/YZH-bot/SC-DLO)
- [DecaYale/RSLO](https://github.com/DecaYale/RSLO) - Robust Self-supervised LiDAR Odometry via Representative Structure Discovery and 3D Inherent Error Modeling, IEEE Robotics and Automation Letters (RA-L) (presented at ICRA 2022)
- [jerredchen/A1_SLAM](https://github.com/jerredchen/A1_SLAM) - A1 SLAM: Quadruped SLAM using the A1's onboard sensors
...
- [changh95/kiss-icp-omp](https://github.com/changh95/kiss-icp-omp) - A LiDAR odometry pipeline that just works - with OpenMP!
- [DarrenWong/code_for_dynaLO](https://github.com/DarrenWong/code_for_dynaLO) - Dynamic Object-aware LiDAR Odometry Aided by Joint Weightings Estimation in Urban Areas
- [samsdolphin/sc_ct_icp](https://github.com/samsdolphin/sc_ct_icp) - Scan Context with CT_ICP
- [504115681/FI-SLAM](https://github.com/504115681/FI-SLAM) - FI-SLAM: Feature Information-Based Robust and Efficient Vision-Inertial-Aided LiDAR SLAM
- [robosu12/GLO](https://github.com/robosu12/GLO) - General LiDAR-Only Odometry with High Efficiency and Low Drift
- [AbangLZU/SC-LeGO-LOAM](https://github.com/AbangLZU/SC-LeGO-LOAM) - LiDAR SLAM: Scan Context + LeGO-LOAM
- [chengwei0427/mad-icp](https://github.com/chengwei0427/mad-icp) - Minimal, robust, accurate and real-time LiDAR odometry [ROS Version]
- [donghwijung/LoRCoN-LO](https://github.com/donghwijung/LoRCoN-LO) - LoRCoN-LO: Long-term Recurrent Convolutional Network-based LiDAR Odometry
- [IMRL/HPPLO-Net](https://github.com/IMRL/HPPLO-Net)
- [mcdermatt/ICET](https://github.com/mcdermatt/ICET) - Real-time LIDAR Odometry and Mapping with Robust Error Bounds
- [Black-Chocolate/sc_lego_loam_noted](https://github.com/Black-Chocolate/sc_lego_loam_noted)
- [RenlangHuang/KDD-LOAM](https://github.com/RenlangHuang/KDD-LOAM) - KDD-LOAM: Jointly Learned Keypoint Detector and Descriptors Assisted LiDAR Odometry and Mapping
