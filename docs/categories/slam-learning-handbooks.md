...
- [labmlai/annotated_deep_learning_paper_implementations](https://github.com/labmlai/annotated_deep_learning_paper_implementations) - 🧑‍🏫 60+ Implementations/tutorials of deep learning papers with side-by-side notes 📝; including transformers (original, xl, switch, feedback, vit, ...), optimizers (adam, adabelief, sophia...
...
- [TianxingChen/Embodied-AI-Guide](https://github.com/TianxingChen/Embodied-AI-Guide)
...
- [yanyan-li/SLAM-BOOK](https://github.com/yanyan-li/SLAM-BOOK)
- [DmitryRyumin/ICCV-2023-25-Papers](https://github.com/DmitryRyumin/ICCV-2023-25-Papers) - ICCV 2023-2025 Papers: Discover cutting-edge research from ICCV 2023-25, the leading computer vision conference. Stay updated on the latest in computer vision and deep learning, with code...
...
- [ProgramTraveler/Road-To-Autonomous-Driving](https://github.com/ProgramTraveler/Road-To-Autonomous-Driving)
- [teadocs/matplotlib-cn](https://github.com/teadocs/matplotlib-cn)
- [JanuszBedkowski/gpu_computing_in_robotics](https://github.com/JanuszBedkowski/gpu_computing_in_robotics)
- [nebula-beta/SLAM-Jobs](https://github.com/nebula-beta/SLAM-Jobs)
- [quandy2020/LTSLAM](https://github.com/quandy2020/LTSLAM) - You can learn slam step by step，there are lot of tutorials
- [Eddie-Wang1120/Professional-CUDA-C-Programming-Code-and-Notes](https://github.com/Eddie-Wang1120/Professional-CUDA-C-Programming-Code-and-Notes)
...
- [CAST-Robotics/ICRA-2023-review](https://github.com/CAST-Robotics/ICRA-2023-review) - A review of papers presented at ICRA 2023, showcases the latest research and innovations in the field of robotics and automation.
- [PetWorm/IMU_error_state_propagation_doc](https://github.com/PetWorm/IMU_error_state_propagation_doc)
- [jlblancoc/factor-graphs-course](https://github.com/jlblancoc/factor-graphs-course)
- [liyongliang999/slam_in_autonomous_driving_change](https://github.com/liyongliang999/slam_in_autonomous_driving_change)
- [zhuhu00/SLAM_Research_notes](https://github.com/zhuhu00/SLAM_Research_notes)
- [zouyajing/multi_sensor_loclization_and_mapping](https://github.com/zouyajing/multi_sensor_loclization_and_mapping) - localization and mapping based on multiple sensor fusion
