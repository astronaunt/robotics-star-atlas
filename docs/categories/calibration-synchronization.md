...
- [ZiliangMiao/Hybrid_Mapping_Cocalibration](https://github.com/ZiliangMiao/Hybrid_Mapping_Cocalibration)
- [APRIL-ZJU/learn-to-calibrate](https://github.com/APRIL-ZJU/learn-to-calibrate) - [IROS2025] The World's First RL-based Sensor Calibration Method: A Targetless, User-friendly, and Robust Approach.
- [xmba15/automatic_lidar_camera_calibration](https://github.com/xmba15/automatic_lidar_camera_calibration) - auto-calibration of lidar and camera based on maximization of intensity mutual information
...
- [unmannedlab/camera_imu_lidar_calibration](https://github.com/unmannedlab/camera_imu_lidar_calibration) - A Package for Camera, IMU, Lidar Joint Calibration.
- [PRBonn/ipb_calibration](https://github.com/PRBonn/ipb_calibration) - Joint Intrinsic and Extrinsic Calibration of Perception Systems Utilizing a Calibration Environment
